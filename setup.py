...
# worker-startup log.
#CUSTOM_COMMANDS = [["pip", "install", "-e", "git://github.com/ibeltagy/allennlp@fp16_and_others#egg=allennlp"]]
CUSTOM_COMMANDS = [
        ["pip", "install", "regex==2019.11.1"],
        ["pip", "install", "git+https://github.com/ibeltagy/allennlp@ac2b21da6008d0e41d31192ea596153988c000a4#egg=allennlp"],
